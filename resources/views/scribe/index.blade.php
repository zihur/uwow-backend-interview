    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="">
                    <a href="#">訂單管理</a>
                                ...
                                <a href="#-GETapi-orders--id-">取得單筆訂單資料</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="-POSTapi-orders">
                                <a href="#-POSTapi-orders">新增一筆訂單資料</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
    ...
    <p>訂單相關 API 管理</p>
                                ...
                                <h2 id="-GETapi-orders--id-">取得單筆訂單資料</h2>

<p>
</p>

<p>這邊因應題目要求使用 ShowOrderRequest 驗證 url param，scribe 會出現兩個 id 欄位混淆</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>訂單資料的 ID Example: <code>A0000001</code></p>
            </div>
...
<p>Must not be greater than 8 characters. Example: <code>bngzmiyv</code></p>
                    ...
                    <h2 id="-POSTapi-orders">新增一筆訂單資料</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>訂單 ID Example: <code>A0000001</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
